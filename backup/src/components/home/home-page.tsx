...
import { getOrganizationBySlug } from "@/data/organizacao";
...
export default function HomePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const organization = await getOrganizationBySlug(pathname.replace("/", ""));
      ...
      try {
        if (organization) {
          ...
          const marmitexData = await getMarmitexByOrganizationId(
            organization.id
          );
